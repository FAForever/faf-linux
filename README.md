...
1. Install prerequisites from your distribution's package manager:
   - Debian and derivatives (Ubuntu, Pop!\_OS, Linux Mint, etc):
     ...
     - `sudo apt install git curl jq cabextract libvulkan1:amd64 libvulkan1:i386`
   ...
   - Fedora and Red Hat-based:
     - `sudo dnf install git curl jq cabextract vulkan-loader.x86_64 vulkan-loader.i686`
   - Arch Linux and derivatives (Manjaro, EndeavourOS, etc):
     ...
     - `sudo pacman -Syu git curl jq cabextract vulkan-icd-loader lib32-vulkan-icd-loader`
   - Gentoo Linux:
      ...
      - `sudo emerge -a dev-vcs/git net-misc/curl app-misc/jq app-arch/cabextract media-libs/vulkan-loader` (feel free to exclude any ebuilds that is already present in your system, no need to rebuild)
   ...
   - Other distributions:
     - Commands needed: `git`, `curl`, `jq`, `cabextract`
     - Libraries needed:
